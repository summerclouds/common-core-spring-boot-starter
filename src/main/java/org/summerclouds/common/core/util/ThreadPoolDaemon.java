 ...
 */
public class ThreadPoolDaemon extends ThreadPool implements Runnable {
    ...
    public ThreadPoolDaemon(Runnable _task, String _name) {
        super(_task, _name);
        // TODO Auto-generated constructor stub
    }

    public ThreadPoolDaemon(Runnable _task) {
        super(_task);
        // TODO Auto-generated constructor stub
    }

    public ThreadPoolDaemon(String _name) {
        super(_name);
        // TODO Auto-generated constructor stub
    }
    ...
    @Override
    public ThreadPoolDaemon start() {
        tc = start(this, name);
        return this;
    }

    private static ThreadContainer start(ThreadPoolDaemon _task, String _name) {
