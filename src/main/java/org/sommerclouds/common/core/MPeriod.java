...
public class MPeriod {
    ...
    public static final long SECOUND_IN_MILLISECONDS = 1000;
    public static final long MINUTE_IN_MILLISECONDS = SECOUND_IN_MILLISECONDS * 60;
    ...
    public static final long WEEK_IN_MILLISECOUNDS = DAY_IN_MILLISECONDS * 7;
    ...
    public static long toMilliseconds(String interval, long def) {
        ...
        try {
            ...
            if (sec != null) out = out + MCast.tolong(sec, 0) * SECOUND_IN_MILLISECONDS;
    ...
    public static long toTime(String in, long def) {
        ...
        if (in.endsWith("s")
            ...
            return MCast.tolong(MString.integerPart(in), 0) * SECOUND_IN_MILLISECONDS;
